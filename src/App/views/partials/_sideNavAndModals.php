<section class="section-side-nav">
    <div class="logo-box mrg-bottom">
        <a class="link flex-container" href="homePage">
            <img
                class="logo-sw"
    ...
    <!-- sidenav -->
    <nav class="side-nav-box flex-container">
        <a
            href="/homePage"
            class="link nav-box flex-container"
            data-tooltip="Home">
            <img
                class="logo-sw"
                src="/assets/imgs/save-wave-circle.png"
        ...
        <a href="/expenses" class="link nav-box flex-container" data-tooltip="Expenses">
            <ion-icon class="nav-icon" name="file-tray-full-outline"></ion-icon>
            <span>Expenses</span>
        </a>
        <a href="/balance" class="link nav-box flex-container" data-tooltip="Balance">
            <ion-icon class="nav-icon" name="stats-chart-outline"></ion-icon>
            <span>Balance</span>
        </a>
        <a href="/goals" class="link nav-box flex-container" data-tooltip="Goals">
            <ion-icon class="nav-icon" name="heart-half-outline"></ion-icon>
            <span>Goals</span>
        </a>
        <a href="/settings" class="link nav-box flex-container" data-tooltip="Settings">
            <ion-icon class="nav-icon" name="settings-outline"></ion-icon>
            <span>Settings</span>
        </a>
        <a href="/logout" class="link nav-box flex-container" data-tooltip="Logout">
